...
namespace AbpBlog.ObjectExtending
{
    public static class AbpBlogDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the AbpBlogEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
